...
§
火山方舟(ARK): key在~/backend/.env的ARK_API_KEY，base https://ark.cn-beijing.volces.com/api/v3。视频POST /contents/generations/tasks(注意generations非generators)，图片doubao-seedream-5-0-260128。Seedance模型/价格/坑见volcengine-ark-api技能。
§
